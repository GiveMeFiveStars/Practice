...
-- ----------------------------
INSERT INTO `administrator` VALUES ('fine', '789', '姜宇涵', 17358639907, '轩然公司');
INSERT INTO `administrator` VALUES ('good', '123', '张雨轩', 17300224091, '轩然公司');
INSERT INTO `administrator` VALUES ('rubbish', '456', '陈嘉睿', 17358651327, '轩然公司');
INSERT INTO `administrator` VALUES ('well', '7488', '刘雨欣', 17546981200, '轩然公司');
...
CREATE TABLE `machine`  (
  ...
  INDEX `machine_ibfk_1`(`stash_id`) USING BTREE,
...
CREATE TABLE `vehicle`  (
  ...
  `stash_id` int NULL DEFAULT NULL COMMENT '所属仓库',
  `e_id` int NULL DEFAULT NULL COMMENT '驾驶员',
  `license_id` int NOT NULL COMMENT '许可证编号',
  `t_limit` date NOT NULL COMMENT '有效期限',
  PRIMARY KEY (`v_id`) USING BTREE,
  INDEX `vehicle_ibfk_2`(`e_id`) USING BTREE,
  INDEX `vehicle_ibfk_3`(`stash_id`) USING BTREE,
